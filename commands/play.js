    ...
    run: async function (client, message, args) {
        ...
        if (serverQueue) {
            ...
            let thing = new MessageEmbed()
                .setAuthor("ꜱᴏɴɢ ʜᴀꜱ ʙᴇᴇɴ ᴀᴅᴅᴇᴅ ᴛᴏ Qᴜᴇᴜᴇ", "https://cdn.discordapp.com/emojis/824304807371210762.png?v=1")
                .setImage(song.img)
                .setColor("#303136")
        ...
        const play = async (song) => {
            ...
            let thing = new MessageEmbed()
                .setAuthor("ꜱᴛᴀʀᴛᴇᴅ ᴘʟᴀʏɪɴɢ ᴍᴜꜱɪᴄ!", "https://cdn.discordapp.com/emojis/824304807371210762.png?v=1")
